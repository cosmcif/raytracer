...
public:
    ...
    static glm::vec3 generateRandomDirectionInHemisphere(const glm::vec3& normal) {
        ...
        float theta = glm::acos(glm::sqrt(glm::linearRand(0.0f, 1.0f)));  // Polar angle
    ...
    glm::vec3 computeSoftShadow(const glm::vec3 &point, const glm::vec3 &normal, const std::vector<Object*>& objects) {
        ...
        for (int i = 0; i < numSamples; ++i) {
            ...
            glm::vec3 randomDir = generateRandomDirectionInHemisphere(normal);
